    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-align-justify"></i>О тренировках</div>
                        <div class="card-body">
                            <table class="table table-responsive-sm table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                <tr>
                                    <td>Тренировки при менструации</td>
                                    <td>Менструальный цикл — сложный биологический процесс, происходящий в половых органах женщины через приблизительно равные промежутки времени...</td>
                                    <td class="btns-edit">
                    ...
                    <div class="card">
                        <div class="card-header"><i class="fa fa-align-justify"></i>О мотивации</div>
                        <div class="card-body">
                            <table class="table table-responsive-sm table-bordered table-striped table-sm">
                                <thead>
                                <tr>
...
<?php echo $__env->make('admin.dashboard.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Desktop\fit\fitness-nutrition\fitness-test\resources\views/admin/dashboard/question/questionList.blade.php ENDPATH**/ ?>