         ...
         <div class="modal-content plugin-modal__content">
            ...
            <div class="workout-checkboxes">
               <label class="workout-checkbox__label" v-for="(caloric, index) in calorics" :key="index">
                  <input class="check__input" @click="disabled = !disabled" type="checkbox" :id="caloric.title" :value="caloric.title" v-model="caloric.value">
            ...
            <form class="plugin-modal-form" v-if="activeStep === 1">
               <div class="plugin-checkboxes">
                  <label class="plugin-checkbox__label" v-for="(diet, index) in diets" :key="diet.index">
                     <input @click="disabledBtn = !disabledBtn" class="check__input" type="checkbox" v-model="diet.value">
               ...
               <button type="button" :disabled="disabledBtn ? false : true" class="plugin-modal-form__btn btn-none" @click.prevent="next()">оплатить</button>
