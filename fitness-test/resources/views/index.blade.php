        ...
        <div class="modal-content modal-custom__content modal-entrance__content">
            <button type="button" class="modal__close" data-dismiss="modal" aria-label="Close">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect y="16.3125" width="23.0694" height="2.38648" transform="rotate(-45 0 16.3125)"
                          fill="#9180FF"/>
                    <rect x="1.68752" width="23.0694" height="2.38648" transform="rotate(45 1.68752 0)" fill="#9180FF"/>
                </svg>
            </button>
            ...
            <form class="modal__form">
                ...
                <button type="button" class="button modal__btn" data-dismiss="modal">
                    ВХОД
                </button>
            </form>
        </div>
