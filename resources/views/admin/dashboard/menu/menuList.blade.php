        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <a href="/admin/menu/add" class="btn btn-primary btn-lg mb-3">Добавить</a>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-align-justify"></i>Все меню</div>
                        <div class="card-body">
                                    ...
                                    <g>
                                        <path d="M256,96C144.341,96,47.559,161.021,0,256c47.559,94.979,144.341,160,256,160c111.656,0,208.439-65.021,256-160
                                            ...
                                            s-48-21.49-48-48s21.49-48,48-48S256,178.49,256,205z"/>
                                                ...
                                                <a href="/admin/menu/edit/{{$menu->id}}" class="users-btn btn btn-block btn-primary">
